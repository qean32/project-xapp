...
export const Overlay = () => {
    ...
    return (
        <div
            className={cn("bg-color p-3 py-2 fit-content overflow-hidden overlay rounded-b-md", (boolean ? 'h-[35px]' : 'h-[75px]'))}
            ...
            <div className="flex gap-2">
                ...
                <img src="/svg/arrow.svg" alt=""
                    style={!boolean ? { transform: 'rotate(90deg)' } : { transform: 'rotate(-90deg)' }}
